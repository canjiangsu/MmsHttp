...
import com.socsi.mmstest.pdu.CharacterSets;
import com.socsi.mmstest.pdu.EncodedStringValue;
import com.socsi.mmstest.pdu.PduBody;
import com.socsi.mmstest.pdu.PduComposer;
import com.socsi.mmstest.pdu.PduPart;
import com.socsi.mmstest.pdu.SendReq;
...
public class MainActivity extends Activity {
    private static final String TAG = "MmsHttp";
    ...
    private void initButtons() {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                send(mContext, "13055252823", "测试彩信", null, null, null);
            }
        });
    }
    ...
    private void acquireNetWork() {
        ...
        Log.d(TAG, "acquireNetWork: timed out");
